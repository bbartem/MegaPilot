// Данный пример меняет межсимвольный интервал бегущей строки.   //
                                                                 //
...
//  Запускаем бегущую строку:                                    // До этого мы только загрузили текст бегущей строки, но не выводили её!
    ...
    disp.setCharInterval(3);                                     // Меняем межсимвольный интервал на 3 пикселя.
    disp.setCharIndent(1);                                       // Меняем отступ первого символа от левого края на 1 пиксель.
}                                                                //
                                                                 //
void loop(){                                                     //
}                                                                //